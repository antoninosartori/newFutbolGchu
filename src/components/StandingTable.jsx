   ...
   return (
      <section className="container mx-auto w-full">
         ...
         <div className="md:max-w-[750px] m-auto">
            <div className="grid md:p-4 md:grid-cols-table_md uppercase bg-primary-700 text-white rounded-t-3xl">
               <div>pos</div>
               <div></div>
               <div>equipo</div>
            ...
            {
               table?.map((team, idx) => (
                  <article className="grid md:p-4 md:grid-cols-table_md odd:bg-slate-100 even:bg-slate-200 last:rounded-b-rounded-b-3xl" key={team.equipo_id}>
                     <div>{idx + 1}</div>
                     <div>
