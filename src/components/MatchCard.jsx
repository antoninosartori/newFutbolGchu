export default function MatchCard({ match = [] }) {
   ...
   return (
      ...
      // </article>
      <article className="grid grid-cols-3 py-4 text-primary-900 uppercase hover:bg-primary-700 rounded-3xl odd:bg-slate-100 even:bg-slate-200 min-w-[300px]">
